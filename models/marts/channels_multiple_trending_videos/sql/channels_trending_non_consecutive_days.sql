...
, channels_videos_multiple_trending_gaps as (
    ...
    select
        ...
        channels_multiple_trending_gaps.channel_id
        , channels_multiple_trending_gaps.video_id
        , flattened.value::date as trending_date

    from channels_multiple_trending_gaps
    , lateral flatten(input => channels_multiple_trending_gaps.trending_dates) as flattened
...
, final as (
    ...
    select
        ...
        , int_channels_multiple_trending_videos.likes_count

        , int_channels_multiple_trending_videos.comment_count
        , int_channels_multiple_trending_videos.view_count
        , array_size(int_channels_multiple_trending_videos.tags)                                                                                         as tags_count
        ...
        , datediff(day, channels_videos_multiple_trending_gaps_dates.previous_trending_date, channels_videos_multiple_trending_gaps_dates.trending_date) as days_of_gap_from_previous

    from channels_videos_multiple_trending_gaps_dates

    left join int_channels_multiple_trending_videos
        on
            channels_videos_multiple_trending_gaps_dates.video_id = int_channels_multiple_trending_videos.video_id
